...
public interface CommonService {
     ...
     */
    <T extends CommonEntity> T getEntity(final Class<T> entity, final long id) throws NoResultException;
     ...
     *
     * @param   <T>     a subtype of <code>NamedEntity</code>
     * @param   entity  the subtype of <code>NamedEntity</code> that shall be retrieved
     ...
     */
    <T extends NamedEntity> T getEntity(final Class<T> entity, final String name) throws NoResultException;
     ...
     */
    <T extends NamedEntity> boolean contains(final Class<T> entity, final String name);
}
